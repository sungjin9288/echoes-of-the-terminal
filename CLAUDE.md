...
│   ├── app.py               # FastAPI 앱 — 라우트 12종 (+ /records, /api/daily/start, /api/settings/theme|lang) + lifespan 정리 태스크
...
│
├── tests/                   # pytest 테스트 (34파일, 870케이스, 커버리지 81%+)
...
| `test_web_session.py` | 80 | 로비·쿠키·클래스·SSE·레이트 리밋·커맨드·세션·records·데일리 챌린지·테마 토글·i18n 토글 |
