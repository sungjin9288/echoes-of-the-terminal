...
│   ├── app.py               # FastAPI 앱 — 라우트 13종 (+ /records, /achievements, /api/daily/start, /api/settings/theme|lang) + lifespan 정리 태스크
...
│
├── tests/                   # pytest 테스트 (34파일, 879케이스, 커버리지 81%+)
...
| `test_web_session.py` | 89 | 로비·쿠키·SSE·레이트 리밋·세션·records·데일리·테마·i18n·achievements 갤러리 |
