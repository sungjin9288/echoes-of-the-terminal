...
├── achievement_system.py    # 106종 업적 시스템 (970줄)
...
| 파일 | 케이스 | 내용 |
|---|---|---|
| `test_achievement_system.py` | 78 | 106종 업적 해금 조건 + 중복 방지 검증 |
| `test_artifact_effects.py` | 12 | 20종 아티팩트 runtime 수정 검증 |
