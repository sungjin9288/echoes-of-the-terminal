...
├── achievement_system.py    # 75종 업적 시스템 (707줄)
...
| 파일 | 케이스 | 내용 |
|---|---|---|
| `test_achievement_system.py` | 50 | 75종 업적 해금 조건 + 중복 방지 검증 |
